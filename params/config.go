...
func (c *ChainConfig) String() string {
	...
	var DeployerProxySunsetTime *big.Int
	if c.DeployerProxySunsetTime != nil {
		DeployerProxySunsetTime = big.NewInt(0).SetUint64(*c.DeployerProxySunsetTime)
	}
...
// IsDeployerProxySunsetTime returns whether time is equal to or past the DeployerProxySunset fork timestamp.
func (c *ChainConfig) IsDeployerProxySunsetTime(time uint64) bool {
	return isTimestampForked(c.DeployerProxySunsetTime, time)
}
...
type Rules struct {
	...
	IsBohr, IsPascal, IsPrague, IsLorentz, IsMaxwell, IsFermi bool
	IsOsaka, IsMendel, IsAmsterdam, IsPasteur, IsVerkle       bool
}

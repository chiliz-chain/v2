...
var (
	...
	BSCChainConfig = &ChainConfig{
		...
		// NEW: Add the BurnBlock here
		BurnBlock: big.NewInt(13082000), // Block number for the burn feature
...
type ChainConfig struct {
	...
	BurnBlock *big.Int `json:"burnBlock,omitempty"` // Block where burn feature activates
...
// IsBurn returns whether num is either equal to the burn block or greater.
func (c *ChainConfig) IsBurn(num *big.Int) bool {
	return isBlockForked(c.BurnBlock, num)
}

...
func (api *API) GetSnapshot(number *rpc.BlockNumber) (*Snapshot, error) {
	...
	return api.parlia.snapshot(api.chain, header.Number.Uint64(), header.Hash(), nil, api.parlia.chainConfig.IsFire(header.Time), header)
}
...
func (api *API) GetValidators(number *rpc.BlockNumber) ([]common.Address, error) {
	...
	snap, err := api.parlia.snapshot(api.chain, header.Number.Uint64(), header.Hash(), nil, api.parlia.chainConfig.IsFire(header.Time), header)
	if err != nil {
		return nil, err
	}
